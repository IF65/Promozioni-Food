...
Case of 
	...
	: ($azione="inizializzaArray")
		...
		ARRAY TEXT:C222(arPR_sottoTipo; 0)
		...
		ARRAY TEXT:C222(arPR_idModelli; 0)
	...
	: ($azione="caricaArray")
		...
		If ($httpResponse=200) & (<>error=0)
			...
			For ($i; 1; Size of array:C274($elencoPromozioni))
				...
				APPEND TO ARRAY:C911(arPR_sottoTipo; OB Get:C1224($elencoPromozioni{$i}; "sottoTipo"; Is text:K8:3))
				...
				APPEND TO ARRAY:C911(arPR_idModelli; OB Get:C1224($elencoPromozioni{$i}; "idModelli"; Is text:K8:3))
			...
			End for 
			SORT ARRAY:C229(arPR_codice; arPR_codiceCatalina; arPR_id; arPR_tipo; arPR_sottoTipo; arPR_descrizione; arPR_ripetibilita; arPR_dataInizio; arPR_dataFine; \
				...
				arPR_pmt; arPR_barcode; arPR_testo; arPR_idModelli; arPR_soglia; arPR_importo; arPR_numeroSedi; >)
		End if 
