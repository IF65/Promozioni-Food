Case of 
	: (Form event code:C388=On Clicked:K2:4)
		...
		Else 
			...
			End if 
			If ($ok=True:C214)
				If (vPR_tipo="DELC") | (vPR_tipo="DELV") | (vPR_tipo="DELP")
					If (Size of array:C274(arRI_soglia)=1)
						If (Size of array:C274(arAR_barcode)>0)
							vPR_testo:=utlCreaPmtDeliveryDaTemplate ("A";vPR_tipo;vPR_codice;vPR_dataInizio;vPR_dataFine;arRI_soglia{1};arRI_ammontare{1};arRI_limiteSconto{1};->arAR_barcode)
						Else 
							ALERT:C41("Barcode mancanti!";"Annulla")
						End if 
					Else 
