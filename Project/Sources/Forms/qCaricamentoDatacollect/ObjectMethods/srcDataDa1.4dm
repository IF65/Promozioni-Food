...
Case of 
	...
	: (Form event code:C388=On Load:K2:1)
		...
		If (True:C214)
			DatePicker SET MIN DATE ($FormName;!2019-01-01!)  //min date is current date minus 15 days
			DatePicker SET MAX DATE ($FormName;Current date:C33)  //max date is current date plus 1 year
		End if 
